    ...
    <div className="login--form">
        ...
        <form className="form--content">
            <div className="form-row">
                <Field type="text" placeholder="Entry your username..." label="Username" id="username" class={''}/>
            </div>
            <div className="form-row">
        ...
        <div className="registration--info">
                not registered? <button onClick={props.openRegistrModal} className="registration--link">Create an account</button>
        </div>
    </div>
  )
}
